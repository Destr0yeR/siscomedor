...
class NutricionistaController extends \BaseController {
	...
	public function ingresarMenuSemanal()
	{	
		$hoy = date('N');
		...
		$fecha 		= date('Y-m-d');
		$almuerzo 	= Menu::where('fecha','=',$fecha)->where('tipo',0)->first();
		$cena 		= Menu::where('fecha','=',$fecha)->where('tipo',1)->first();
	...
	public function guardarMenuSemanal()
	{
